...
while(cap.isOpened()):
    ...
    for encodeFrame, faceFrame in zip(encodeLive, faceLocLive):
        ...
        cv2.putText(img, f'{results}, Fenris', (50,50), cv2.FONT_HERSHEY_SIMPLEX,1,(0,0,255),2) if results == [True] else cv2.putText(img, f'{results}', (50,50), cv2.FONT_HERSHEY_SIMPLEX,1,(0,0,255),2) 
